...
import CertificateData from '../../../projectsResource/certificate';
                ...
                <Grid container spacing={3}>
                    <Grid item md={4}>
                        ...
                        <div className={"fontStyle"}
                            ...
                            <h1 className={"subheading"}>Certificates</h1>
                        </div>
                    </Grid>
                    <Grid item md={8} xs={12}>
                        <div className={"fontStyle"} style={styles.contentSection}>
                            {certificateData.map(institute =>
                                <div>
                                    <InsertDriveFileIcon fontSize="large" style={styles.uniIcon}/> <span
